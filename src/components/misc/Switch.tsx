...
const switchVariants = tv({
  slots: {
    root: [
      ...
      // checked
      "data-[state=checked]:bg-accent data-[state=checked]:dark:bg-accent",
      // disabled
      "data-[disabled]:cursor-default",
      // disabled checked
      "data-[disabled]:data-[state=checked]:bg-accent",
      "data-[disabled]:data-[state=checked]:ring-gray-300",
      // disabled checked dark
      "data-[disabled]:data-[state=checked]:dark:ring-gray-900",
      "data-[disabled]:data-[state=checked]:dark:bg-accent",
      // disabled unchecked
